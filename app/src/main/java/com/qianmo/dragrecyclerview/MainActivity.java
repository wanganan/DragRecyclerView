...
public class MainActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        ms.setOrientation(LinearLayoutManager.VERTICAL);//左右布局改为HORIZONTAL
        mRecyclerView.setLayoutManager(ms);
        mRecyclerView.addItemDecoration(new DividerItemDecoration(this, DividerItemDecoration.VERTICAL_LIST));//左右布局改为HORIZONTAL_LIST
        ...
        mItemTouchHelper = new ItemTouchHelper(new ItemTouchHelper.Callback() {
            ...
            public int getMovementFlags(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
                if (recyclerView.getLayoutManager() instanceof GridLayoutManager) {
                    ...
                    final int dragFlags = ItemTouchHelper.UP | ItemTouchHelper.DOWN;//左右布局改为LEFT和RIGHT
                    final int swipeFlags = 0;
